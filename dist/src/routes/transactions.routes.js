...
var ImportTransactionsService2_1 = __importDefault(require("../services/ImportTransactionsService2"));
...
transactionsRouter.get('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var transactionRepository, transaction, balance;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                balance = _a.sent();
                return [2 /*return*/, response.json({ transactions: transaction, balance: balance })];
        }
    });
}); });
...
transactionsRouter.post('/import', upload.single('file'), function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var file, importTransaction, transaction;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                file = path_1.default.resolve(upload_1.default.directory, 'import_template.csv');
                importTransaction = new ImportTransactionsService2_1.default();
                return [4 /*yield*/, importTransaction.execute(file)];
            case 1:
                transaction = _a.sent();
                return [2 /*return*/, response.json(transaction)];
        }
