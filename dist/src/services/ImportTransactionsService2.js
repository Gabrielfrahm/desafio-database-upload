...
var ImportTransactionsService2 = /** @class */ (function () {
    function ImportTransactionsService2() {
    }
    ImportTransactionsService2.prototype.execute = function (filePath) {
        return __awaiter(this, void 0, void 0, function () {
            var transactions, categories, categoriesRepositories, transactionsRepository, contactsReadSteam, parsers, parseCSV, existesCategories, existesCategoriesTitle, addCategoryTitle, newCategory, finalCategories, createdTransactions;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        contactsReadSteam = fs_1.default.createReadStream(filePath);
                        parsers = csv_parse_1.default({
                            // pula linha do arquivo
                            from_line: 2,
                        });
                        parseCSV = contactsReadSteam.pipe(parsers);
                    ...
                    case 2:
                        existesCategories = _a.sent();
                        existesCategoriesTitle = existesCategories.map(function (category) { return category.title; });
                        addCategoryTitle = categories
                            .filter(function (category) { return !existesCategoriesTitle.includes(category); })
                            // aqui ele retira as duplicadas de categories assim pegamos apenas uma de cada tipo
                            .filter(function (value, index, self) { return self.indexOf(value) === index; });
                        newCategory = categoriesRepositories.create(addCategoryTitle.map(function (title) { return ({
                            title: title,
                        }); }));
                        // salva no banco
                        return [4 /*yield*/, categoriesRepositories.save(newCategory)];
                    case 3:
                        // salva no banco
                        _a.sent();
                        finalCategories = __spreadArrays(newCategory, existesCategories);
    ...
    return ImportTransactionsService2;
}());
exports.default = ImportTransactionsService2;
