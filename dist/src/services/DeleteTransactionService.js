...
var DeleteTransactionService = /** @class */ (function () {
    ...
    DeleteTransactionService.prototype.execute = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var transactionRepository, findTransaction;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        findTransaction = _a.sent();
                        if (!findTransaction) {
                            throw new AppError_1.default('Transaction not exists!');
                        }
                        return [4 /*yield*/, transactionRepository.remove(findTransaction)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
