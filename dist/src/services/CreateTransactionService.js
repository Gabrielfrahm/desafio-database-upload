...
var CreateTransactionService = /** @class */ (function () {
    ...
    CreateTransactionService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var transactionRepository, categoryRepository, total, category_id, findCategoryTitle, newCategory, transaction;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (!['income', 'outcome'].includes(type)) {
                            throw new AppError_1.default('Transaction type is not available');
                        }
                        return [4 /*yield*/, transactionRepository.getBalance()];
                    case 1:
                        total = (_b.sent()).total;
                        if (type === 'outcome' && total < value) {
                            throw new AppError_1.default('transfer does not accept limit reached');
                        }
                        category_id = '';
                    ...
                    case 2:
                        findCategoryTitle = _b.sent();
                        if (!!findCategoryTitle) return [3 /*break*/, 4];
